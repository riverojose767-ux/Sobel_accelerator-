...
expected_outputs = (IMG_W - 2) * (IMG_H - 2)
edge_count = sum(edges[y][x] for y in range(IMG_H) for x in range(IMG_W))

print("============================================================")
print("PYTHON GOLDEN MODEL SUMMARY")
print("============================================================")
print(f"Input image                  = {INPUT_IMAGE}")
print(f"Image size                   = {IMG_W} x {IMG_H}")
print(f"Total input pixels           = {IMG_W * IMG_H}")
print(f"Mode                         = {MODE.upper()}")

if MODE == "fixed":
    print(f"Fixed threshold value        = {THRESHOLD}")
else:
    print("Adaptive threshold type      = 8x8 block mid range")
    print("Threshold equation           = (max + min + 1) >> 1")

print(f"Expected valid edge outputs  = {expected_outputs}")
print(f"Total edges detected         = {edge_count}")
print("")
print("Created output files:")
print(f"  {EXPECTED_TXT}")
print(f"  {EXPECTED_IMG}")
print(f"  {EXPECTED_JPG}")
print("")
print(f"PASS: Expected valid edge outputs = counted valid edge outputs")
print(f"PASS: {expected_outputs} = {expected_outputs}")
print(f"PASS: Python golden model generated {edge_count} detected edges.")
print("============================================================")